...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.author.setOnClickListener {
            ...
            val webpage: Uri = Uri.parse("https://d-s.netlify.app")
